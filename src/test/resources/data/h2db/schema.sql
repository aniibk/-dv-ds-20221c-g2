...
--
-- Drop Table structure for table tiendas
--
DROP TABLE IF EXISTS tiendas;
--

-- Drop Table structure for table ventas_tienda
--
...
CREATE TABLE ventas (
  ...
  vta_tienda_id bigint NOT NULL,
  PRIMARY KEY (vta_id),
  KEY vta_cli_fk (vta_cli_id),
  CONSTRAINT vta_cli_fk FOREIGN KEY (vta_cli_id) REFERENCES clientes (cli_id),
  CONSTRAINT vta_ti_fk FOREIGN KEY (vta_tienda_id) REFERENCES tiendas (tienda_id)
);
...
CREATE TABLE ventas_tienda (
  venta_tienda_id bigint NOT NULL AUTO_INCREMENT,
  venta_id int NOT NULL,
  tienda_id bigint NOT NULL,
  PRIMARY KEY (venta_tienda_id),
  KEY venta_id_fk (venta_id),
  CONSTRAINT venta_id_fk FOREIGN KEY (venta_id) REFERENCES ventas (vta_id),
  KEY tienda_id_fk (tienda_id),
  CONSTRAINT tienda_id_fk FOREIGN KEY (tienda_id) REFERENCES tiendas (tienda_id)
);
