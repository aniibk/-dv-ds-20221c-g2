...
public abstract class Venta implements Serializable {
	...
	@ManyToOne(targetEntity = Tienda.class, cascade = CascadeType.PERSIST, fetch = FetchType.LAZY)
	@JoinColumn(name="vta_tienda_id", referencedColumnName="tienda_id", nullable = false)
	@JsonBackReference
