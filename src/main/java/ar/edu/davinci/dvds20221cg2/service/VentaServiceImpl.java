...
public class VentaServiceImpl implements VentaService {
	...
	public VentaEfectivo save(VentaEfectivo venta) throws BusinessException {
		...
		Tienda tienda = null;
		if (venta.getTienda().getId() != null) {
			tienda = getTienda(venta.getTienda().getId()); 
		} else {
			throw new BusinessException("La tienda es obligatoria");
		}
	...
	private Tienda getTienda(Long id) throws BusinessException {
